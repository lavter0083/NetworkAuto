...
if __name__ == "__main__":
    # 사용자에게 시간대를 입력받습니다.
    print "What time do you want to see the command executed?"
    input_date = raw_input("enter the year-day-time (ex, 2016-08-11 14) :")
    ...
    print start_date, "~", end_date, "enter command"
    print "-" * 70
